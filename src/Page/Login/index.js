...
function Login() {
    return ( 
        <div className='login-form'>
            <form action='' method='POST' className='form-login-1'>
                <div className='logo-spotify'> 
                    <svg role="img" viewBox="0 0 78 24" 
                    height="100%" className="Svg-sc-6c3c1v-0 jrsLlJ">
                ...
                <div className='title-continue' >To continue, log in to Spotify.</div>
                <div className="form-message">
                    {/* Báo lỗi */}
                    <div className='log-error'>
                      <i className="fa-solid fa-circle-exclamation log-error-icon"></i>
                ...
                <div className='button-group'>
                    <button className='button-login button-facebook'>
                        <i className="fa-brands fa-square-facebook button-icon"></i>
                        <span>CONTINUE WITH FACEBOOK</span>
                    </button>
                    <button className='button-login button-apple'>
                        <i className="fa-brands fa-apple button-icon"></i>
                        <span>CONTINUE WITH APPLE</span>
                    </button>
                    <button className='button-login'>
                        <i className="fa-brands fa-google button-icon"></i>
                        <span className='text-button'>CONTINUE WITH GOOGLE</span>
                    </button>
                    <button className='button-login'>
                        <span className='text-button'>CONTINUE WITH PHONE NUMBER</span>
                    </button>
                </div>
                ...
                <div className='form-input'>
                   <div className='form-group'>
                        ...
                        <input id='fullname' name='fullname' type='text' placeholder='Email address or username' className='form-control'/>
                   </div>
                   <div className='form-group'>
                   ...
                   <div className='form-submit'>
                        <div className='remember-me'>
                            <input type="checkbox" id="remember" name="remember" className='checkbox-control'/>
                            <label className='remember-label' htmlFor='checkbox'>Remember me</label>
                        </div>
                        <button className='button-submit'>
                            <span className='text-button-submit'>LOG IN</span>
                        </button>
                   </div>
                   <div className='line-or'>
                        <hr className='line-hr'/>
                    ...
                    <div className='button-group'>
                        <div className='out-tittle'>Don't have an account?</div>
                        <button className='button-login'>
                            <span className='text-button'>SIGN UP FOR SPOTIFY</span>
                        </button>
                    </div>
